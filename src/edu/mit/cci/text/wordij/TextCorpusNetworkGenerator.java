 ...
 * @param <T>
 */
public class TextCorpusNetworkGenerator<T extends Windowable> implements CorpusToNetworkGenerator<T> {
    ...
    Logger log = Logger.getLogger(TextCorpusNetworkGenerator.class);


    public TextCorpusNetworkGenerator(BinningStrategy<T> bmodel,
                                      TextToNetworkGenerator calculator) {
